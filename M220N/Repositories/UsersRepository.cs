    ...
    public class UsersRepository
    {
        ...
        */
        ...
        public async Task<User> GetUserAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            var filter = Builders<User>.Filter.Eq(it => it.Email, email);
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _usersCollection
                    .WithWriteConcern(
                        new WriteConcern(new Optional<WriteConcern.WValue>(), journal: new Optional<bool?>(true))
                    )
                    .InsertOneAsync(user)
                ;
                */
                await _usersCollection
                    //.WithWriteConcern(new WriteConcern(w: 2))
        ...
        public async Task<UserResponse> LoginUserAsync(User user, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var sessionFilter = Builders<Session>.Filter.Eq(s => s.UserId, user.Id);
        ...
        )
        {
            ...
            try
            {
                ...
                */
                ...
                var sessionFilter = Builders<User>.Filter.Eq(s => s.Email, email);
