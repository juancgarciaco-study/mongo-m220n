...
namespace M220N.Repositories
{
    ...
    public class MoviesRepository
    {
            ...
            )
        {
            ...
            // JK Model -
            var filter1 = Builders<Movie>.Filter.In("countries", countries);
            var filter = Builders<Movie>.Filter.AnyIn(it => it.Countries, countries);
            var sortByYearDescending = Builders<Movie>.Sort.Descending(it => it.Title);
            ...
            return await _moviesCollection
                ...
                .Project<MovieByCountryProjection>(
            ...
            int page = 0, params string[] genres)
        {
            ...
            */
            ...
            // JK Model -
            var sort = new BsonDocument(sortKey, DefaultSortOrder);
            var filter = Builders<Movie>.Filter.AnyIn(it => it.Genres, genres);
            returnValue = await _moviesCollection
               .Find(filter)
               .Limit(limit)
               .Skip(page * limit)
